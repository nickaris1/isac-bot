      ...
      if (response.status === 200) {
        if (response.data.data.segments.length > 0) {
          playerData = {
            ...
            specialization: response.data.data.segments[0].stats.specialization
              .displayValue
              ? response.data.data.segments[0].stats.specialization.displayValue
              : '-',
            /*avatar: response.data.data.platformInfo.avatarUrl,*/
            gearscore:
              response.data.data.segments[0].stats.latestGearScore.value,
            ecredits: response.data.data.segments[0].stats.eCreditBalance.value
            ...
            xp_ow_30d: null,
            kills_pve_hyenas:
              response.data.data.segments[0].stats.killsFactionBlackbloc.value,
            kills_pve_outcasts:
            ...
            maxtime_rogue:
              response.data.data.segments[0].stats.timePlayedRogueLongest.value,
            kills_pvp_dz_rogue:
            ...
            kills_pve_dz_outcasts:
              response.data.data.segments[0].stats.killsFactionDzCultists.value,
            kills_pve_dz_blacktusk:
              response.data.data.segments[0].stats.killsFactionDzEndgame.value,
            kills_pve_dz_truesons:
              response.data.data.segments[0].stats.killsFactionDzMilitia.value,
            kills_pvp_dz_total:
